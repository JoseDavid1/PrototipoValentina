...
<div class="container">
    ...
    <h1 align="center">¿En dónde te gustaría enterarte de nuestros servicios?</h1>
    ...
    <!-- Bloque de Urología -->
        <div class="col-md-3">
            <div class="card h-43" style="width: 18rem">
            <img class="card-img-top" src="whats.jpg" alt="Card image cap" width="120" height="150">
            <div class="card-body"> 
                <h1 align="center">
                <label class="btn btn-secondary" >
                    <input type="radio" name="options" id="option1" autocomplete="off" value="whats" > Whatsapp
                </label>
                </h1>
            </div>
            </div>
